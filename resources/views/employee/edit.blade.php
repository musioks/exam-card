...
<section id="configuration">
        ...
        <div class="col-xs-12">
            <div class="card">
                <div class="card-header bg-purple bg-lighten-1">
                    <h4 class="card-title text-white">Update Employee</h4>
    ...
    <p class="card-text"><a href="{{url('/employees/employee')}}" class="btn btn-success">
        <i class="icon-arrow-left3"></i> Go Back</a></p>
                        <hr>       
 <form class="form-horizontal" method="post" action="{{ url('/employees/update/'.$user->id) }}"  novalidate="">
    @csrf
...
<div class="col-md-8">
<input type="text" class="form-control" placeholder="ID Number" value="{{$user->nid}}" name="id_no" required data-validation-required-message= "id number is required">
...
<div class="col-md-4">
<div class="form-group row">
<label class="col-md-4 label-control" for="userinput2">Employee Number</label>
<div class="col-md-8">
<div class='input-group'>
<input type='text' class="form-control" name="empno" value="{{$user->empno}}" placeholder="employee no" required>
</div>
<div class="help-block font-small-3"></div>
</div>
</div>
