...
<section id="configuration">
        ...
        <div class="col-xs-12">
            <div class="card">
                <div class="card-header bg-purple bg-lighten-1">
                    <h4 class="card-title text-white">Add Employee</h4>
    ...
    <p class="card-text"><a href="{{url('/employees/employee')}}" class="btn btn-success">
        <i class="icon-arrow-left3"></i> Go Back</a></p>
                        <hr>       
 <form class="form-horizontal" method="post" action="{{ url('/employees/store') }}"  novalidate="">
     @csrf
<div class="form-body">
...
<div class="col-md-8">
<div class='input-group'>
<input type='text' class="form-control" name="empno" value="{{old('empno')}}" placeholder="employee no">
</div>
<div class="help-block font-small-3"></div>
@if ($errors->has('empno'))
