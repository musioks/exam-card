...
<div class="card-body">
    <div class="card-block pt-3">
        <img src="../../../app-assets/images/elements/01.png" alt="element 01" width="140" class="float-xs-left">
...
<div class="card-body">
    <div class="weather-img position-relative">
        ...
        <img class="card-img-top img-fluid height-250" src="../../../app-assets/images/backgrounds/snow_rain.gif" alt="Card image cap">
    </div>
...
<div class="card-body">
    <img src="../../../app-assets/images/carousel/29.png" alt="Relax" width="230" class="img-fluid">
    <div class="card-block px-1">
        <h4 class="card-title mb-0">Brand Minute</h4>
        <p class="card-text">Donut toffee candy brownie soufflé macaroon.</p>
        <button class="btn bg-white bg-darken-3 danger">Buy Now</button>
    </div>
</div>
</div>
</div>
...
<div class="card-body">
    <img src="../../../app-assets/images/elements/07.png" alt="element 04" class="float-xs-left mt-3 img-fluid" width="140">
    <div class="card-block pt-3">
