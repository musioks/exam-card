...
<section id="configuration">
        ...
        <div class="col-xs-12">
            <div class="card">
                <div class="card-header bg-purple bg-accent-4">
                    <h4 class="card-title text-white">Manage Teachers</h4>
    ...
    <p class="card-text"><a  href="{{url('/staff/create')}}" class="btn btn-warning" style="float: right;">
        <i class="icon-plus"></i>Add A Teacher</a></p>
                        <hr>
       ...
       @php $i=0; @endphp
        ...
        <tr>
         ...
         <td>
             ...
             <a href="{{url('/staff/edit/'.$staff->id)}}" class="btn btn-success"><i class="icon-pencil"></i></a>
         </td>
         <!-- ====================Delete Modal===========================  -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <a href="{{ url('/staff/delete/'.$staff->id) }}" class="btn btn-success float-sm-left">Okay</a>
